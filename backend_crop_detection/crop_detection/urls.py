...
from .views import (
    ...
    ForumCommentDeleteView, LikeDislikeCommentView, voice_query_view, predict_outbreak #ForumPostView, ForumCommentView,
)
...
urlpatterns = [
    ...
    path('predict-outbreak/', predict_outbreak, name='predict-outbreak'),
    path('genai/voice_query/', voice_query_view, name='voice-query'),
